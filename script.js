...
"feat-viewer-title":"Multi-Tabbed PDF Viewer","feat-viewer-desc":"Open and manage multiple PDF documents simultaneously in a clean, tabbed interface with lightning-fast local performance.","feat-metaedit-title":"Metadata Editor","feat-metaedit-desc":"View and edit document properties including Title, Author, Subject, Keywords, Creator, and Producer tags directly on your device.",
...
"feat-viewer-title":"Çoklu Sekmeli PDF Okuyucu","feat-viewer-desc":"Birden fazla PDF belgesini tek bir pencerede, modern sekmeli arayüz ile son derece hızlı ve çevrimdışı olarak görüntüleyin.","feat-metaedit-title":"Metadata Düzenleyici","feat-metaedit-desc":"Belgelerinizin Başlık, Yazar, Konu, Anahtar Kelimeler, Oluşturan ve Üretici etiketlerini doğrudan cihazınızda düzenleyin.",
...
"feat-viewer-title":"Lecteur PDF multi-onglets","feat-viewer-desc":"Ouvrez et gérez plusieurs documents PDF simultanément dans une interface claire à onglets avec des performances locales ultra-rapides.","feat-metaedit-title":"Éditeur de métadonnées","feat-metaedit-desc":"Affichez et modifiez les propriétés du document (Titre, Auteur, Sujet, Mots-clés, Créateur, Producteur) directement sur votre appareil.",
...
"feat-viewer-title":"Multi-Tab PDF-Viewer","feat-viewer-desc":"Öffnen und verwalten Sie mehrere PDF-Dokumente gleichzeitig in einer übersichtlichen Tab-Oberfläche mit blitzschneller lokaler Leistung.","feat-metaedit-title":"Metadaten-Editor","feat-metaedit-desc":"Anzeigen und Bearbeiten von Dokumenteigenschaften wie Titel, Autor, Betreff, Schlüsselwörter, Ersteller und Produzent direkt auf Ihrem Gerät.",
...
"feat-viewer-title":"Visor PDF de pestañas múltiples","feat-viewer-desc":"Abra y administre múltiples documentos PDF simultáneamente en una interfaz limpia con pestañas y rendimiento local ultrarrápido.","feat-metaedit-title":"Editor de metadatos","feat-metaedit-desc":"Vea y edite las propiedades del documento, incluidos el Título, Autor, Asunto, Palabras clave, Creador y Productor directamente en su dispositivo.",
...
"feat-viewer-title":"Visualizzatore PDF multi-scheda","feat-viewer-desc":"Apri e gestisci più documenti PDF contemporaneamente in un'interfaccia a schede pulita con prestazioni locali ultra-rapide.","feat-metaedit-title":"Editor di metadati","feat-metaedit-desc":"Visualizza e modifica le proprietà del documento, inclusi Titolo, Autore, Oggetto, Parole chiave, Creatore e Produttore direttamente sul tuo dispositivo.",
...
"feat-viewer-title":"多标签 PDF 查看器","feat-viewer-desc":"在简洁的标签式界面中同时打开和管理多个 PDF 文档，享受极速的本地处理性能。","feat-metaedit-title":"元数据编辑器","feat-metaedit-desc":"直接在您的设备上查看和编辑文档属性，包括标题、作者、主题、关键词、创建者 and 生成者标签。",
...
"feat-viewer-title":"マルチタブPDFビューア","feat-viewer-desc":"複数のPDFドキュメントをすっきりとしたタブインターフェースで同時に開き、高速なローカル処理パフォーマンスで管理します。","feat-metaedit-title":"メタデータエディタ","feat-metaedit-desc":"タイトル、著者、件名、キーワード、作成者、製作者タグを含むドキュメントのプロパティをデバイス上で直接表示および編集します。",
...
"feat-viewer-title":"Многовкладочный PDF-ридер","feat-viewer-desc":"Открывайте и управляйте несколькими PDF-документами одновременно в удобном вкладочном интерфейсе с молниеносной локальной производительностью.","feat-metaedit-title":"Редактор метаданных","feat-metaedit-desc":"Просматривайте и редактируйте свойства документа, включая Название, Автор, Тема, Ключевые слова, Создатель и Производитель, прямо на вашем устройстве.",
...
"feat-viewer-title":"قارئ PDF متعدد التبويبات","feat-viewer-desc":"افتح وأدر مستندات PDF متعددة في نفس الوقت من خلال واجهة تبويب نظيفة وبأداء محلي فائق السرعة.","feat-metaedit-title":"محرر البيانات الوصفية","feat-metaedit-desc":"اعرض وحرر خصائص المستند بما في ذلك العنوان، والمؤلف، والموضوع، والكلمات المفتاحية، والمنشئ، والمنتج مباشرة على جهازك.",
